...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('news_post', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 16, 11, 56, 10, 590085)), keep_default=False)
    ...
    models = {
        ...
        'news.post': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 12, 0, 32, 82719)', 'blank': 'True'}),
