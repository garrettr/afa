...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_post', 'visible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.visible'
        db.delete_column('news_post', 'visible')
    ...
    models = {
        ...
        'news.post': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 14, 12, 56, 0, 331189)'}),
