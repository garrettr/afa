...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('news_post', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 11, 16), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.pub_date'
        db.delete_column('news_post', 'pub_date')
    ...
    models = {
        ...
        'news.post': {
            ...
            'event_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 16, 12, 10, 42, 268320)', 'blank': 'True'}),
